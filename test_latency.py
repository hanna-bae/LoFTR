...
from src.lightning.data import DummyDataModule
...
if __name__ == '__main__':
    ...
    # Use DummyDataModule instead of MultiSceneDataModule
    data_module = DummyDataModule(args.batch_size)
    loguru_logger.info(f"DummyDataModule initialized!")
